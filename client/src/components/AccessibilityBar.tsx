  ...
  if (!prefs.barOpen) {
    return (
      <button
        ...
        title="נגישות"
      >
        <svg className="a11y-toggle__icon" viewBox="0 0 363.071 363.071" aria-hidden="true">
          <path
            fill="currentColor"
            d="M257.648,275.122c-2.462-1.443-5.271-2.205-8.126-2.205c-5.713,0-11.056,3.066-13.933,8.012
          ...
          <path
            fill="currentColor"
            d="M342.588,278.703c-3.049-3.329-7.375-5.235-11.885-5.235c-4.047,0-7.921,1.509-10.902,4.248L311.858,285l-50.305-62.378
